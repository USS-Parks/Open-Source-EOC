...
1. Run `deploy\Open-Source-EOC-Setup-0.9.0.exe` from this repository (or a
   copy of it; 1.6 GB, SHA-256 in the `.sha256` file beside it). It needs no administrator rights and no internet connection,
