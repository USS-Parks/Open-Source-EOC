...
- `docs/process/VEOCI-AIR-GAP-PSPR-2026-09-25.md` is the live roster and the approved execution authority, approved by Basho 2026-09-25 for STS with full permissions ("V1 grant: Veoci integration and air gap" in the ledger). Its research basis is `docs/process/VEOCI-PLATFORM-RESEARCH-2026-09-24.md` and `docs/process/AIR-GAP-READINESS-AUDIT-2026-09-25.md`.
- `docs/process/EXERCISE-SCENARIOS-PSPR-2026-09-25.md` is a second live roster beside it, approved by Basho 2026-09-25 for STS with express permissions throughout: the execution authority for its own units, XS1 to XS8 (three exercise scenarios for the demo). It runs in its own lane and owns files the Veoci roster leaves to it (its section 2).
- `docs/process/IPAWS-CONNECTOR-PSPR-2026-09-25.md` is a third live roster, approved by Basho 2026-09-25 for STS ("IPAWS connector grant" in the ledger): the execution authority for IC1 to IC3, the rebuild of the IPAWS-OPEN connector to FEMA's Interface Design Guide. It owns `server/src/ipaws/`, `web/src/ipaws/` and the IPAWS tests. Its research basis is `FEMA-IPAWS-INTEGRATION-RESEARCH-2026-09-25.md`.
