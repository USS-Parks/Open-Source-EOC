...
- `docs/process/LOCAL-AI-AND-PUBLIC-PAGE-PSPR-2026-09-26.md`, approved by Basho 2026-09-26 ("Local AI and public page grant" in the ledger), is queued: it runs after the map and dashboard plan's 1.0.0 release and ends with 1.1.0 (a local AI assistant and a separate public page). A Dashboard Aesthetics PSPR, giving the product its own design rather than parity, follows its AP12.
