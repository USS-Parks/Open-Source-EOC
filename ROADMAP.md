...
(`docs/VIRTUAL-EOC-PSPR-2026-09-17.md`); this is the readable summary.
Live status per capability: `docs/FACET-STATUS.md`.
...
| F | Collaboration and ICS operations: incident spaces, meetings, the JIC, ICS forms and IAP, resource requests, after-action | not started |
| G | Hardening and release: security, load (150+ concurrent users), accessibility, packaging, docs, pilot exercise, 1.0 disposition | not started |

Nothing is deployable before Phase G closes.
