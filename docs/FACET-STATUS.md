...
| F5 | ICS forms, IAP builder, 213RR lifecycle | VEOC-34/35; incident-context IAP `8c96103`; P-IAP `a5b96f9`; "V1 W3.8: JIC and resources completion"; "V1 W4.8: resources"; "V1 79D+D33 part one: the integrated cross-boundary exercise"; "Partner sharing PS1: shared incident requests" (partner requests, owner assigns, under Basho's request ownership decision) | verified | Not claimed ("V1 W6.5: training kit"): objectives and ICS-208 fields; more than one current operational period; ICS-201, ICS-211 and ICS-215 from Resources or Staffing; an ICS-205 with content; guest read of resources |
