...
|---|---|---:|---|
| F1 | Board primitive: versioned schema, input + display views | VEOC-09, VEOC-10 | open |
| F2 | Position login + immutable activity/position logs | VEOC-07, VEOC-11 | open |
| F3 | Store-and-forward federation, local replication | VEOC-30 | open |
| F4 | Board-triggered notifications, webhooks, multi-channel | VEOC-14 | open |
| F5 | ICS forms, IAP builder, 213RR lifecycle | VEOC-34, VEOC-35 | open |
| F6 | Any board as a live geospatial layer; field-to-COP loop | VEOC-16, VEOC-17 | open |
...
| F12 | Incident templates instantiating ICS org + checklists | VEOC-12 | open |
| F13 | Scenario libraries, reference libraries, checklists | VEOC-12 | open |
| F14 | Calm-screen map-first SPA discipline | VEOC-05, VEOC-17 | open |
...
| F18 | Sensor and drone live feeds into the COP | VEOC-19 | open |
| F19 | NAPSG/DHS incident symbology shipped | VEOC-17 | open |
...
| R5 | File sharing | VEOC-15 | open |
| R6 | Private and group messaging | VEOC-15A, VEOC-32 | open |
