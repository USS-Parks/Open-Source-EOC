...
| G-IMPACT | Incident-area impact analysis (affected structures/parcels/population) | Esri-EMO | 79G-E1 source-backed spatial contract and real-PostGIS revision/coverage/population proof; API, deltas, report links and presentation remain | partial | VEOC-79G-E2, P-DASH |
