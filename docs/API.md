...
- `GET /api/v1/me/sms-numbers`: Read me sms numbers (auth: bearer; audience: operator)
- `POST /api/v1/me/sms-numbers/code`: Run me sms numbers code (auth: bearer; audience: operator)
- `POST /api/v1/me/sms-numbers/confirm`: Run me sms numbers confirm (auth: bearer; audience: operator)
...
- `POST /api/v1/peers/:peerId/exchange/export`: Run peers exchange export (auth: bearer; audience: operator)
- `POST /api/v1/peers/:peerId/exchange/import`: Run peers exchange import (auth: bearer; audience: operator)
- `POST /api/v1/peers/:peerId/exchange/receipt`: Run peers exchange receipt (auth: bearer; audience: operator)
