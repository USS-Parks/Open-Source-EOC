...
| FEMA USA Structures occupancy | Added to `buildings.pmtiles` by `tools/basemap/build-building-occupancy.mjs`; the source points and their receipts stay in the ignored `tools/basemap/out/`. | FEMA and Oak Ridge National Laboratory USA Structures, read from FEMA Region 9's structure point layer on FEMA's own ArcGIS organization (`https://services.arcgis.com/XG15cJAlne2vxtgt/arcgis/rest/services/USAStructures_Region9_Point/FeatureServer/0`, data edited 2026-01-23), for Del Norte, Humboldt, Siskiyou and Trinity counties: 120,764 points, 27,578,167 bytes, SHA-256 `d88d2c0679b1a0d16e124d2dd8727fc1b186b62e8d0b8f4136dec353ac801aa1`, retrieved 2026-09-26. A United States Government work: FEMA's metadata sets no access or use constraints, and ORNL's Figshare deposit of the California file is CC0 1.0. The statewide file (2,190,645,592 bytes) was not downloaded. | Public domain. Shipped inside the buildings archive; credited on the map while buildings draw and in the setup's notices. |
| Buildings sidecar | `web/public/basemap/buildings-overture.json` | Project data: the Overture release, the USA Structures edition and counties, and the byte count and SHA-256 of the installed buildings archive, read by the Windows launcher before it shows either credit. No third-party content. | Distributed under the repository license. |
...
| Buildings archive | `web/public/basemap/buildings.pmtiles`, 343,522,896 bytes, with `buildings-overture.json` | OpenStreetMap footprints (ODbL-1.0) enriched with Overture buildings release 2026-08-19.0 subtypes (ODbL-1.0) by exact OSM-way match, and in Del Norte, Humboldt, Siskiyou and Trinity counties with FEMA USA Structures occupancy classes (public domain) by the structure point inside each footprint. | Project-recorded; the sidecar's SHA-256 matches the archive; no ODbL text in the setup |
...
| Critical facilities archive | `web/public/basemap/facilities.pmtiles`, 27,166,921 bytes, with `facilities-manifest.json` | 73,472 California facilities in 23 types from United States Government public domain data (USGS National Structures Dataset, FEMA State EOCs, CMS nursing homes and dialysis placed with Census TIGER/Line address ranges, EIA-860, EPA FRS, FCC antenna structures, FAA NASR, USACE National Inventory of Dams, FHWA National Bridge Inventory, BTS principal ports) and OpenStreetMap points from the street archive (ODbL-1.0), built by `tools/basemap/build-facilities.mjs`. The manifest records every source's URL, license, retrieval date, size and SHA-256. | Project-recorded in the manifest and `tools/basemap/README.md` section 11; the OpenStreetMap part is credited in the setup's notices |
| Boundaries archive | `web/public/basemap/boundaries.pmtiles`, 4,685,106 bytes, with `boundaries-manifest.json` | California tribal areas (152 Census TIGER/Line 2025 AIANNH areas, 112 BIA AIAN Land Area Representations), 58 counties and 1,619 places from the Census 2025 Cartographic Boundary Files, and label points, all United States Government works, built by `tools/basemap/build-reference-layers.mjs`. The manifest records every source's URL, license, retrieval date, size and SHA-256, and BIA's no-legal-inference disclaimer in full. | Public domain; project-recorded in the manifest, `tools/basemap/README.md` section 12 and the setup's notices |
| Risk archive | `web/public/basemap/risk.pmtiles`, 13,510,099 bytes, with `risk-manifest.json` | FEMA National Risk Index v1.20 ratings and CDC/ATSDR SVI 2022 rankings for 9,106 and 9,109 California tracts and 58 counties, on Census 2025 cartographic boundaries, built by `tools/basemap/build-reference-layers.mjs`. The Risk Index is a United States Government work offered under FEMA's terms, which require a non-endorsement statement; CDC states the SVI carries no constraints. | Project-recorded in the manifest (FEMA's terms and required statement), `tools/basemap/README.md` section 12 and the setup's notices; FEMA's terms accepted by Basho on 2026-09-26 |
