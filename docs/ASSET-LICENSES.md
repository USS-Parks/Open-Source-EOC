...
| H14 Overture building subtype enrichment | Candidate generated by `deploy/basemap/build-overture-buildings.ps1`; statewide archives remain untracked. | Overture buildings release 2026-08-19.0, schema v1.18.0, ODbL-1.0. Canonical acquisition retains manifest, official license text and verification receipts under `deploy/basemap/out/overture/`. Source SHA-256: `1c32b65f761899b253387cdf77835c8f12306de6e23aa70d77d634e430ac49af`. Exact-way candidates are clipped to `ca_state.geojson`; OSM geometry and identity remain authoritative. | Deployment-supplied/generated. Attribution requires a verified installed release or explicit deployment configuration. |
