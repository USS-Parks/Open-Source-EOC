...
| H14 Overture building subtype enrichment | Candidate generated by `tools/basemap/build-overture-buildings.ps1`; statewide archives remain untracked. | Overture buildings release 2026-08-19.0, schema v1.18.0, ODbL-1.0. Canonical acquisition retains manifest, official license text and verification receipts under `tools/basemap/out/overture/`. Source SHA-256: `1c32b65f761899b253387cdf77835c8f12306de6e23aa70d77d634e430ac49af`. Exact-way candidates are clipped to `ca_state.geojson`; OSM geometry and identity remain authoritative. | Deployment-supplied/generated. Attribution requires a verified installed release or explicit deployment configuration. |
| Bundled California basemap | `web/public/basemap/` | `tools/basemap/build-bundled-basemap.sh` records Natural Earth 10m and California county boundaries; `tools/basemap/README.md` identifies Natural Earth and US Census inputs as public domain. No separate upstream license text is vendored. | Distributed; provenance and public-domain status are project-recorded. |
...
| Self-hosted OpenStreetMap street and building tiles | `tools/basemap/generate-california.sh`, `tools/basemap/buildings-schema.yml` | The generation guide records OpenStreetMap ODbL attribution and requires the map to display `© OpenStreetMap contributors`. The generated statewide archives are not tracked. | Deployment-supplied. |
...
| NAPSG attribution and commercial-use statement | `https://www.napsgfoundation.org/symbology/` (acquisition snapshot: `tools/basemap/out/napsg-input/napsg-attribution-source.html`) | `FAAA4F52246F1F4F750297738DEBD4F10FDA3E3EA5E17602923C4F9EDE1C3041` |
